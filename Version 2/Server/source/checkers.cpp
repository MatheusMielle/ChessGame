...
//#include "../headers/assign_boards.h"
...
void promotePawn(char array[sides][sides][3], int i, int j, int color)
{
    ...
    if (piece == 'P' && (i == 7 || i == 0))
    {
        ...
        //{
            while (!right_pice)
            {
                ...
                cout << "Choose a piece to promote the pawn to! (R for Rook, N for Knight, B for Bishop, Q for Queen): ";
                cin >> promotionChoice;
